...
describe("Order repository test", () => {
  ...
  it("should update a order", async () => {
    ...
    expect(orderModel.toJSON()).toStrictEqual({
      ...
      items: [
        {
          id: orderUpdate.items[0].id,
          name: orderUpdate.items[0].name,
          order_id: orderUpdate.id,
          price: orderUpdate.items[0].price,
          product_id: orderUpdate.items[0].productId,
          quantity: orderUpdate.items[0].quantity
        },
      ],
    });
  });
